...
import { OrderDetailsScreen } from '../screens/sales/OrderDetailsScreen.jsx';
import { ReturnsScreen } from '../screens/returns/ReturnsScreen.jsx';
import { ReturnSuccessScreen } from '../screens/returns/ReturnSuccessScreen.jsx';
...
import { PaymentSuccessScreen } from '../screens/checkout/PaymentSuccessScreen.jsx';
...
export const retailRoutes = [
  <Route key="retail" path={base} element={<RetailLayout />}>
    ...
    <Route path="payment-complete" element={<PaymentSuccessScreen />} />
    <Route path="held-sales" element={<HeldSalesScreen />} />
    <Route path="sales" element={<SalesScreen />} />
    <Route path="sales/:id" element={<OrderDetailsScreen />} />
    <Route path="returns" element={<ReturnsScreen />} />
    <Route path="returns/success" element={<ReturnSuccessScreen />} />
